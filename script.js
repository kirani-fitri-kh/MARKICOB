...
const DEFAULT_PRODUCTS = [
  { id:1, name:"Notebook Vintage Rose", category:"stationery", price:45000, stock:15, icon:"📓", image:"images/notebook-vintage-rose.jpg",
  ...
  { id:2, name:"Pulpen Gel Pastel Set (5pcs)", category:"stationery", price:35000, stock:20, icon:"🖊️", image:"images/cat-stationery.svg",
  ...
  { id:3, name:"Pembatas Buku Bunga Kering", category:"stationery", price:15000, stock:0, icon:"🔖", image:"images/cat-stationery.svg",
    desc:"Pembatas buku laminasi berisi bunga kering asli — unik, estetik, dan tak ada satupun yang sama persis." },
  { id:4, name:"Sticker Pack Aesthetic Diary", category:"stationery", price:18000, stock:30, icon:"✨", image:"images/cat-stationery.svg",
    desc:"Kumpulan stiker aesthetic bertema bunga dan bintang untuk mempercantik diary, planner, maupun laptop kesayanganmu." },
  { id:5, name:"Planner Mingguan Dreamy", category:"stationery", price:52000, stock:2, icon:"🗒️", image:"images/cat-stationery.svg",
  ...
  { id:6, name:"Lampu Tidur Bulan Mini", category:"hiasan", price:85000, stock:10, icon:"🌙", image:"images/cat-hiasan.svg",
    desc:"Lampu tidur meja berbentuk bulan sabit dengan cahaya hangat yang menenangkan, cocok menemani malam-malam tenangmu." },
  { id:7, name:"Lampu Gantung String Fairy Lights", category:"hiasan", price:60000, stock:12, icon:"🪔", image:"images/cat-hiasan.svg",
    desc:"Lampu gantung LED berbentuk untaian bintang, mudah dipasang untuk mempercantik dinding kamar maupun area belajar." },
  { id:8, name:"Keychain Bunga Resin", category:"hiasan", price:22000, stock:25, icon:"🔑", image:"images/cat-hiasan.svg",
    desc:"Gantungan kunci resin bermotif bunga asli yang diawetkan — cantik, ringan, dan tahan lama dibawa ke mana saja." },
  { id:9, name:"Jam Meja Mini Klasik", category:"hiasan", price:75000, stock:1, icon:"🕰️", image:"images/cat-hiasan.svg",
    desc:"Jam meja mini bergaya klasik elegan, mempercantik meja belajar sekaligus menemani rutinitasmu tetap tepat waktu." },
  { id:10, name:"Cermin Kecil Bingkai Bunga", category:"hiasan", price:40000, stock:8, icon:"🪞", image:"images/cat-hiasan.svg",
    desc:"Cermin kecil dengan bingkai bunga estetik, pas diletakkan di meja rias maupun rak buku sebagai sentuhan manis." },
  { id:11, name:"Blind Box Fantasy Garden", category:"blindbox", price:95000, stock:14, icon:"🌸", image:"images/cat-blindbox.svg",
    desc:"Blind box bertema taman fantasi berisi karakter-karakter imut serba misteri — kejutan menyenangkan di setiap kotaknya." },
  { id:12, name:"Blind Box Cry Baby Series", category:"blindbox", price:98000, stock:0, icon:"😢", image:"images/cat-blindbox.svg",
    desc:"Blind box tema Cry Baby yang ekspresif dan menggemaskan, favorit para kolektor figur unik." },
  { id:13, name:"Blind Box Dark Academia", category:"blindbox", price:98000, stock:9, icon:"📚", image:"images/cat-blindbox.svg",
    desc:"Blind box bertema Dark Academia dengan nuansa klasik misterius, cocok untuk pecinta estetika akademik vintage." },
  { id:14, name:"Blind Box Doll Whisper", category:"blindbox", price:99000, stock:6, icon:"🎎", image:"images/cat-blindbox.svg",
    desc:"Blind box tema boneka misterius dengan desain lembut nan artistik, tiap seri membawa ekspresi berbeda." },
  { id:15, name:"Buket Stationery Pastel", category:"buket", price:120000, stock:6, icon:"💐", image:"images/cat-buket.svg",
  ...
  { id:19, name:"Motivation Jar", category:"letter", price:48000, stock:4, icon:"🌟", image:"images/cat-letter.svg",
    desc:"Toples berisi puluhan kartu motivasi harian untuk menyemangati harimu, satu kartu satu semangat baru." },
  { id:20, name:"Secret Letter Box — For Me 10 Years Later", category:"letter", price:55000, stock:3, icon:"✉️", image:"images/cat-letter.svg",
...
function bindNavAndFilters(){
  ...
  document.getElementById("resetFilterBtn").addEventListener("click", ()=>{
    ...
    document.getElementById("navSearchInputMobile").value = "";
  ...
  document.getElementById("navSearchInput").addEventListener("input", (e)=> handleSearchInput(e.target.value));
  document.getElementById("navSearchInputMobile").addEventListener("input", (e)=> handleSearchInput(e.target.value));
